...
public class PriceServiceImpl extends ServiceImpl<MarketMapper, Market> implements PriceService {
    ...
    private static final String UID = "5123892"; // 固定用户ID
    private static final String TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiIiLCJhdWQiOiIiLCJqdGkiOiI1MTI1MDQ4IiwiaWF0IjoxNzUxNTQyOTQ3LCJuYmYiOjE3NTE1NDI5N";
    ...
    public List<MarketVo> getAllPrices() {
        List<MarketVo> prices = new ArrayList<>();
        // 添加所有21个接口的价格获取逻辑
//        prices.add();
        return prices;
    }
...
//        market.setPrice((Double) response.get("list[1].price"));
        market.setPrice(1);
